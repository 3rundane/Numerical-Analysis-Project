...
def f(index, x_1, x_2, x_3):
    ...
    while index >= 1:
        ...
        f_value = (A(i_current, i_subsequent, x_1, x_2, x_3))**2 + f_value
        index = index - 1
    # if index >= 1:
    #     i_subsequent = satellite_keys[index]
    #     i_current = satellite_keys[index - 1]
...
def f_partial_x(index, x_1, x_2, x_3):
    ...
    #     print(index)
    #     print(index-1)
    #     f_partial_xvalue = A_i *X_i + f_partial_x(index - 1, x_1, x_2, x_3)
    # else:
    #     f_partial_xvalue = 0
...
def f_partial_y(index, x_1, x_2, x_3):
    ...
    while index >= 1:
        ...
        A_i = A(i_current, i_subsequent, x_1, x_2, x_3)
        X_i = X(i_current, i_subsequent, x_1, x_2, x_3)
        f_partial_yvalue = f_partial_yvalue + A_i * X_i
        index = index - 1
...
def f_partial_z(index, x_1, x_2, x_3):
    ...
    while index >= 1:
        ...
        A_i = A(i_current, i_subsequent, x_1, x_2, x_3)
        X_i = X(i_current, i_subsequent, x_1, x_2, x_3)
        f_partial_zvalue = f_partial_zvalue + A_i * X_i
        index = index - 1
...
##Peter said starting guess for the first iteration of our for loop should be the coordinates of the lampost b12, the subsequent initial guesses as the program
#goes along should be...
x_0, y_0, z_0 = geo_to_car(120,40,45,55.0,1,111,50,58.0,-1,1372.0)
x, y, z = float(x_0), float(y_0), float(z_0)
condition = True

while condition:
    hessian_row1, hessian_row2, hessian_row3 = Hessian_rows(satty_length - 1, x, y, z)
    # print(B(satty_length - 1, x, y, z))
    # print(hessian_row3)
    B_vector = B(satty_length - 1, x, y, z)
