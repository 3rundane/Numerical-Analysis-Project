...
def iteration_step(epoch_satellites):
    ...
    while condition:
        ...
        if normal_norm(s[0], s[1], s[2]) < 0.01:
            ...
            normy_norm = norm(key,x,y,z)
            t_s = epoch_satellites[key][0]
            t_v = t_s + normy_norm/c
            # print(t_v)
            t, psi_degree, psi_minute, psi_second, NS, lambda_degree, lambda_minute, lambda_second, EW, h = car_to_geo(x,y,z,t_v)
